...
module.exports = {
    ...
    async execute(args, client, msg) {
        ...
        if (blacklistData) return client.createMessage(msg.channel.id, "This User is Already Blacklisted")
        ...
        client.createMessage(msg.channel.id, "User Has Been Blacklisted");
    }
};